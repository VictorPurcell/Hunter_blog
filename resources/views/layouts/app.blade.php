...
<head>
    ...
    <title>@yield('title', 'Hunter x Hunter Blog')</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg hunter-nav">
        <div class="container">
            <a class="navbar-brand hunter-brand" href="{{ url('/') }}">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('characters') }}"><i class="fas fa-users"></i> Personagens</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('nen') }}"><i class="fas fa-fire"></i> Nen</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('blog.index') }}"><i class="fas fa-book"></i> Blog</a>
                    </li>
                    @auth
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('profile.show') }}"><i class="fas fa-user"></i> Perfil</a>
                        </li>
                    @endauth
                </ul>
            </div>
